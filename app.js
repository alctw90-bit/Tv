...
function renderApplicationView() {
    ...
    if (currentFilterCategory === 'favorites') {
        ...
        // নতুন স্মার্ট ফিল্টার: ক্যাটাগরির নামের ভেতর 'sport' বা 'খেলা' লেখা থাকলেই ফিল্টার করবে
        if (currentFilterCategory.toLowerCase() === 'sports') {
            ...
            if(DOM.sectionTitle) DOM.sectionTitle.textContent = 'Live Sports Channels';
        } else {
